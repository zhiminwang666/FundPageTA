...
/**
 * @className: ${YearlyInvestmentAndTotal}
 * @description: Validate the data in column Investment and Investment Total of the table Detail - Invest Yearly
 * @author: Sandy
...
public class YearlyInvestmentAndTotal {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021
		{
			...
			System.out.println("Wealth Formula Yearly Investment and Investment Total Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Yearly Investment and Investment Total Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					// read the first line data in the table Detail - Invest Yearly
					String date1 = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Yearly']/parent::div/following-sibling::div/table/tbody/tr/td"))
							.getText();
					String investment1Str = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Yearly']/parent::div/following-sibling::div/table/tbody/tr/td[7]"))
							.getText();
					String investmentTotal1Str = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Yearly']/parent::div/following-sibling::div/table/tbody/tr/td[8]"))
							.getText();
					...
					int expectedInvestment = dollar * 360;
					...
					for (int i = 2; i <= count; i++) {
						// read the data of following lines in the table Detail - Invest Yearly
