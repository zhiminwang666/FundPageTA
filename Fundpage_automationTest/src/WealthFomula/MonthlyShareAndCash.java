...
/**
 * @className: ${MonthlyShareAndCash}
 * @description: Validate the data in column Share and Cash of the table Detail - Invest Monthly
 * @author: Sandy
...
public class MonthlyShareAndCash {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021
		{
			...
			System.out.println("Wealth Formula Monthly Share and Cash Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Monthly Share and Cash Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					// read the data of first line in the table Detail - Invest Monthly
					...
					String firstPriceStr = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td[2]"))
							.getText();
					...
					String firstShareStr = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td[9]"))
							.getText();
					String firstCashStr = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td[10]"))
							.getText();
