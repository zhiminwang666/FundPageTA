...
/**
 * @className: ${QuarterlyInvestmentAndTotal}
 * @description: Validate the data in column Investment and Investment Total of the table Detail - Invest Quarterly
 * @author: Sandy
...
public class QuarterlyInvestmentAndTotal {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021
		{
			...
			System.out.println("Wealth Formula Quarterly Investment and Investment Total Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Quarterly Investment and Investment Total Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					// read the first line data in the table Detail - Invest Quarterly
					...
					String investmentTotal1Str = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Quarterly']/parent::div/following-sibling::div/table/tbody/tr/td[8]"))
							.getText();
					...
					int expectedInvestment = dollar * 90;
