...
/**
 * @className: ${YearlyTotalValueAndReturn}
 * @description: Validate the data in column Total Value and Return of the table Detail - Invest Yearly
 * @author: Sandy
...
public class YearlyTotalValueAndReturn {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021

		{
			...
			System.out.println("Wealth Formula Yearly Total Value and Return Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Yearly Total Value and Return Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					for (int i = 1; i <= count; i++) {
						// read the data of every line in the table Detail - Invest Yearly
