...
public class MonthlyInvestmentAndTotal {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021

		{
			...
			System.out.println("Wealth Formula Monthly Investment and Investment Total Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Monthly Investment and Investment Total Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					int expectedInvestment = dollar * 30;
