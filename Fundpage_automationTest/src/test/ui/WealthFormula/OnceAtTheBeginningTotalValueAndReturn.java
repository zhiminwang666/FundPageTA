...
/**
 * @className: ${OnceAtTheBeginningTotalValueAndReturn}
 * @description: Validate the data in column Total Value and Return of the table Detail - Invest Once At The Beginning
 * @author: Sandy
...
public class OnceAtTheBeginningTotalValueAndReturn {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021

		{
			...
			System.out.println("Wealth Formula Once At The Beginning Total Value and Return Test");
			System.out.println(stock_info);
			Reporter.log("Wealth Formula Once At The Beginning Total Value and Return Test ");
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					for (int i = 1; i <= count; i++) {
						// read the data of every line in the table Detail - Invest Once At The
						// Beginning
