...
/**
 * @className: ${MonthlyInvestmentAndTotal}
 * @description: Validate the data in column Investment and Investment Total of the table Detail - Invest Monthly
 * @author: sandy
...
public class MonthlyInvestmentAndTotal {
	...
	public void wealthFormula(String stock_info) throws Exception { // "stock_info" added by Greg on October 28, 2021

		{
			...
			System.out.println("Wealth Formula Monthly Investment and Investment Total Test: " + stock_info);
			...
			try {
				...
				while ((line = br.readLine()) != null) // returns a Boolean value
				{
					...
					System.out.println("Wealth Formula Monthly Investment and Investment Total Test: " + "Security: "
							+ stock[0] + ", Date: " + stock[1] + ", Dollar: " + stock[2]);
					Reporter.log("Wealth Formula Monthly Investment and Investment Total Test: " + "Security: "
							+ stock[0] + ", Date: " + stock[1] + ", Dollar: " + stock[2]);
					...
					// read the first line data in the table Detail - Invest Monthly
					String date1 = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td"))
							.getText();
					String investment1Str = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td[7]"))
							.getText();
					String investmentTotal1Str = driver.findElement(By.xpath(
							"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr/td[8]"))
							.getText();
					...
					int dollar = Integer.parseInt(stock[2]);
					int expectedInvestment = dollar * 3;
					int expectedInvestmentTotal1 = (int) (expectedInvestment);
					// Compare the calculated Investment with the shown Investment

					softassert.assertEquals(investment1, expectedInvestment,
							stock[0] + " " + date1 + " Investment is incorrect");
					softassert.assertEquals(investmentTotal1, expectedInvestmentTotal1,
					...
					for (int i = 2; i <= count; i++) {
						// read the data of following lines in the table Detail - Invest Monthly
						...
						String investmentTotalStr = driver.findElement(By.xpath(
								"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr["
										+ i + "]/td[8]"))
								.getText();
						String investmentTotalLastRowStr = driver.findElement(By.xpath(
								"//div[text()='Detail - Invest Monthly']/parent::div/following-sibling::div/table/tbody/tr["
										+ (i - 1) + "]/td[8]"))
								.getText();
						...
						int investmentTotalLastRow = Integer.parseInt(investmentTotalLastRowStr);

						// Calculate Investment Total
						int expectedInvestmentTotal = (int) (investment + investmentTotalLastRow);

						// Compare the calculated Investment with the shown Investment
						softassert.assertTrue(investment == expectedInvestment || investment == 0,
								stock[0] + " " + date + " Investment is incorrect");
						// Compare the calculated Investment Total with the shown Investment Total
						softassert.assertEquals(investmentTotal, expectedInvestmentTotal,
